...
<script type="text/javascript">
	...
	function fn_downloadFile(obj){
	    ...
	    comSubmit.setUrl("<c:url value='/evaluation_filedown.do' />");
			...
			<div class="main" style="width: 70%; height: auto; float:left;">
					...
					<div class="contentWrapper2" >
						...
						<div style="text-align: right; width: 90%;">
							...
							<a href="#" style="background-color: #0065A2; color: #FFFFFF; padding: 10 20px; font-weight: bold; font-size: 15px;" onclick="javascript:history.go(-1);">목록으로</a>
						</div>
