...
var gfv_count = 1;
		...
		function fn_insertExcellent(){
		    ...
		    comSubmit.setUrl("<c:url value='/menu4/menu4_1_insert.do' />");
		    comSubmit.submit();
		}
			...
			<div class="main" style="width: 70%; height: auto; float:left;">
					...
					<form id="frm1" name="frm1" enctype="multipart/form-data">
							...
							<table class="table tlTable">
								...
								<tbody>
									<tr>
										...
										<td class="topLine" colspan="3">
											<select style="width: 98%; height: 30px; margin-left: 10px;" id="submit_field" name="submit_field">
												...
												<option value="1">환경 부문</option> 
												<option value="2">사회 부문</option> 
												<option value="3">경제 부문</option> 
											</select>
										</td>
									</tr>
									...
									<tr>
										...
										<td colspan="">
											<input type="text" class="fl_left" style="width: 98%; height: 25px; margin: 0 4px 0px 10px;" id="policy_title" name="policy_title">
										</td>
									</tr>
									...
									<tr style="height: 280px;"> 
										...
										<td >
											<textarea rows="10" cols="110" style="margin-left: 10px; resize:none;" id="policy_summary" name="policy_summary"></textarea>
										</td>
									</tr>
									<tr style="height: 280px;"> 
										<th style="text-align: center;">주요 내용</th>
										<td colspan="3">
											<textarea rows="10" cols="110" style="margin-left: 10px; resize:none;" id="main_content" name="main_content"></textarea>
										</td>
									</tr>
									<tr style="height: 280px;"> 
										<th style="text-align: center;">시행 효과</th>
										<td colspan="3">
											<textarea rows="10" cols="110" style="margin-left: 10px; resize:none; " id="trial_effect" name="trial_effect"></textarea>
										</td>
									</tr>
									<tr>
						...
						<div style="text-align: right; width: 90%;">
							...
							<a href="/menu4/menu4_1_List.do"  style="background-color: #0065A2; color: #FFFFFF; padding: 10 20px; font-weight: bold; font-size: 15px;">목록으로</a>
